...
*/
    ...
    isEven();
    let s1 = { name: "Anna", course: "OMB", age: 23 };
    let s2 = { name: "Lena", course: "MKB", age: 19 };
    let s3 = { name: "Nick", course: "MIB", age: 21 };
    let arr = [s1, s2, s3, { name: "Tim", course: "OMB", age: 25 }];
    for (var i in arr) {
        for (var j in arr[i]) {
            console.log(arr[3][1]);
        }
